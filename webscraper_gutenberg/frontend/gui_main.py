...
class Ui_MainWindow(object):
    ...
    def enter_button(self):
        ...
        match book_analysis:
            ...
            case 8: 
                ...
                for book in books:
                    word = self.get_id_from_word(self.get_N_input(), book) #NOTE: This needs a better solution. One database connection per book just to get a single word is an unacceptable slowdown...
            ...
            case 10:
                ...
                full_book_text = analysis.cipher_decoder(books[0].get_text(), books[0].get_language(), self.db_config) # decode a full book back to text      
    ...
    def get_id_from_word(self, word, book):
        try:
